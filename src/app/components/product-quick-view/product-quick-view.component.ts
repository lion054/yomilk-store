...
@Component({
  ...
  template: `
    <div *ngIf="isOpen" class="fixed inset-0 z-[9999] flex items-center justify-center p-4 animate-fade-in">
      <!-- Backdrop -->
      <div
        ...
        <div class="overflow-y-auto max-h-[90vh] hide-scrollbar">
          <div class="grid md:grid-cols-2 gap-8 p-8">
            ...
            <div class="flex flex-col space-y-6">
              ...
              <!-- Stock Status -->
              <div *ngIf="stockLevel !== 'InStock'" class="flex items-center gap-2">
                <span
              ...
              <!-- UoM Selector -->
              <div *ngIf="product?.uoMs && product.uoMs.length > 1" class="space-y-2">
                <label class="block text-sm font-semibold text-gray-700">
                  Select Size
                </label>
                <div class="flex flex-wrap gap-2">
                  <button
                    *ngFor="let uom of product.uoMs"
                    (click)="selectUoM(uom)"
                    [class]="uom === activeUoM
