          ...
          @for (order of filteredOrders; track order) {
            <div
              ...
              <div class="p-5">
                ...
                @if (order.ONA_SPOR1Collection && order.ONA_SPOR1Collection.length > 0) {
                  <div class="pt-4 border-t border-gray-100">
                    <p class="text-xs text-gray-500 mb-2">Order Items</p>
                    <div class="flex flex-wrap gap-2">
                      @for (item of order.ONA_SPOR1Collection.slice(0, 3); track item) {
                        <span
                      ...
                      @if (order.ONA_SPOR1Collection.length > 3) {
                        <span
