...
@Component({
  ...
  template: `
    <div class="space-y-6">
      ...
      <div *ngIf="!isLoading && order">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div class="relative">
            ...
            <div class="space-y-6">
              ...
              <div class="relative flex items-start gap-4 pl-10" *ngIf="order.U_Status !== 'Failed'">
                <div
                  class="absolute left-2 w-5 h-5 rounded-full flex items-center justify-center"
                  [ngClass]="isProcessed() ? 'bg-[#42af57]' : 'bg-gray-300'"
                >
                  <i class="fas fa-check text-white text-xs" *ngIf="isProcessed()"></i>
                </div>
                <div>
              ...
              <div class="relative flex items-start gap-4 pl-10" *ngIf="order.U_Status !== 'Failed'">
                ...
                >
                  <i class="fas fa-check text-white text-xs" *ngIf="isInvoiced()"></i>
                </div>
                <div>
              ...
              <div class="relative flex items-start gap-4 pl-10" *ngIf="order.U_Status !== 'Failed'">
                ...
                >
                  <i class="fas fa-check text-white text-xs" *ngIf="isCompleted()"></i>
                </div>
                <div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
          ...
          <div class="hidden sm:block overflow-x-auto">
            <table class="w-full">
              ...
              <tbody class="divide-y divide-gray-100">
                <tr *ngFor="let item of order.ONA_SPOR1Collection" class="hover:bg-gray-50">
                  <td class="px-6 py-4">
          ...
          <div class="sm:hidden divide-y divide-gray-100">
            <div *ngFor="let item of order.ONA_SPOR1Collection" class="p-4">
      ...
      <!-- Not Found -->
      <div *ngIf="!isLoading && !order" class="bg-white rounded-xl border border-gray-200 p-12 text-center">
