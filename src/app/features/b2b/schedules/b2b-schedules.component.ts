              ...
              <div class="p-5 space-y-4">
                ...
                <div>
                  ...
                  <div class="flex flex-wrap gap-2">
                    @for (date of schedule.AvailableDeliveryDates?.slice(0, 5); track date) {
                      <span
                    ...
                    @if (schedule.AvailableDeliveryDates && schedule.AvailableDeliveryDates.length > 5) {
                      <span
